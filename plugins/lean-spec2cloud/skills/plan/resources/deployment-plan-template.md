...
| `AI_PROJECT_DEPLOYMENTS` | `<resolved>` | `foundry-models-selector` skill (when feature uses Foundry models) |
| `ENABLE_HOSTED_AGENTS` | `true` | constant (when feature uses Foundry hosted agents) |
